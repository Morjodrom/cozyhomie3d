...
function GeneratedMesh({ mesh, creaseNormals }: { mesh: MeshData; creaseNormals: boolean }) {
...
function Scene({ mesh, stats, highFidelity, creaseEmbossedRibs, controlsRef }: ViewportProps) {
  ...
  return <>
    ...
    {mesh ? <GeneratedMesh mesh={mesh} creaseNormals={Boolean(highFidelity || creaseEmbossedRibs)} /> : null}
